      ...
      <div className="flex items-center justify-between px-3 py-2 sm:px-6 sm:py-3">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-[#d4c9bc] bg-white px-2.5 py-1.5 text-xs text-[#9e9087] hover:bg-[#ede8df] hover:text-[#4a3d33] transition-colors"
            title="Sign out"
          >
